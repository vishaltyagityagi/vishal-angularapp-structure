...
class RepairsControllerTest < ActionController::TestCase
  ...
  test "should create repair" do
    assert_difference('Repair.count') do
      post :create, repair: { customer_id: @repair.customer_id, description: @repair.description, name: @repair.name, price: @repair.price, status: @repair.status }
    end
  ...
  test "should update repair" do
    patch :update, id: @repair, repair: { customer_id: @repair.customer_id, description: @repair.description, name: @repair.name, price: @repair.price, status: @repair.status }
    assert_redirected_to repair_path(assigns(:repair))
  end
